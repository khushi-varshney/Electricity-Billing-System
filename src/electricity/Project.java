...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype, String meter) {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("./iconss/elect1.jpg"));
        ...
        master.setForeground(Color.PINK);
        setJMenuBar(mb);

        JMenuItem newcustomer = new JMenuItem("New Customer");
        newcustomer.setFont(new Font("monospaced", Font.PLAIN, 12));
        newcustomer.setBackground(Color.lightGray);
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("./iconss/icon1.png"));
        ...
        customerdetails.setBackground(Color.lightGray);
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("./iconss/icon2.png"));
        ...
        ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("./iconss/icon3.png"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("./iconss/icon4.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("./iconss/icon5.png"));
        Image image5 = icon5.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        updateinformation.setIcon(new ImageIcon(image5));
        updateinformation.addActionListener(this);
        updateinformation.setMnemonic('R');
        updateinformation.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R, ActionEvent.CTRL_MASK));
        info.add(updateinformation);

        JMenuItem viewinformation = new JMenuItem("View Information");
        viewinformation.setFont(new Font("monospaced", Font.PLAIN, 12));
        viewinformation.setBackground(Color.lightGray);
        ImageIcon icon6 = new ImageIcon(ClassLoader.getSystemResource("./iconss/icon6.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("./iconss/icon1.png"));
        ...
        billdetails.setBackground(Color.lightGray);
        ImageIcon icon8 = new ImageIcon(ClassLoader.getSystemResource("./iconss/icon2.png"));
        ...
        generatebill.setBackground(Color.lightGray);
        ImageIcon icon9 = new ImageIcon(ClassLoader.getSystemResource("./iconss/icon6.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("./iconss/icon10.png"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("./iconss/icon11.png"));
        ...
        ImageIcon icon12 = new ImageIcon(ClassLoader.getSystemResource("./iconss/icon11.png"));
        Image image12 = icon12.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        exit.addActionListener(this);
        exit.setIcon(new ImageIcon(image12));
        exit.setMnemonic('Z');
        exit.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Z, ActionEvent.CTRL_MASK));
        mexit.add(exit);
