...
public class calculateBill extends JFrame implements ActionListener {
    ...
    calculateBill() {
        ...
        JLabel heading = new JLabel("Calculate The Electricity Bill");
        heading.setBounds(100, 10, 400, 29);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("./iconss/icon4.png"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Customer Bill Updates Successfully");
                setVisible(false);
            } catch (Exception e) {
                e.printStackTrace();
            }
